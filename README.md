...
<pre lang="markdown"> ``` ist-303-team-A/ ├── app.py ├── requirements.txt ├── init_db.py ├── schema.sql ├── src/ │ └── ist303_flask_project/ │ ├── app.py │ ├── requirements.txt │ ├── insert_questions.py │ ├── init_db.py │ ├── schema.sql │ ├── templates/ │ │ ├── index.html │ │ ├── register.html │ │ ├── login.html │ │ ├── quiz_start.html │ │ ├── quiz_question.html │ │ ├── quiz_results.html │ │ ├── quiz_feedback.html │ │ ├── admin_panel.html │ │ ├── add_question.html │ │ ├── edit_question.html │ │ ├── quiz_preview.html │ │ └── quiz_pdf_template.html │ ├── static/ │ │ ├── style.css │ │ └── bootstrap.min.css │ └── venv/ │ ├── Include/ │ ├── Lib/ │ ├── Scripts/ │ └── pyvenv.cfg ├── test/ │ ├── test_auth.py │ ├── test_quiz_flow.py │ ├── test_access_control.py │ └── test_validation.py ├── .github/ │ └── workflows/ │ └── actions.yml ├── .gitignore ├── README.md ├── PART_B.md ├── PART_C.md └── PART_D.md ``` </pre>
